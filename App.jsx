...
function App() {
  ...
  }, [products]); // Sepetteki ürünler değiştikçe toplam tutarı güncelleriz
            ...
            return (
              <div key={product.id}>
                <div className="flex-row" style={{ padding: '20px' }}>
                  ...
                  <p style={{ fontWeight: 'bold', marginRight: '10px', width: '60px' }}>
                    {product.price} TL
                  </p>
                  <button
                    onClick={() => dispatch(removeFromBasket(product.id))} // Silme işlemi
                    style={{
                      padding: '5px',
                      borderRadius: '5px',
